...
namespace FFF.Utils
{
   public static class FurnitureUtils
   {
      ...
      public static float GetProbabilityOfFalling(CatBehavior p_cat, List<FurnitureDropSlotBehaviour> p_lstFurniture)
      {
      ...
      public static int TryClimbing(CatBehavior p_cat, List<FurnitureDropSlotBehaviour> p_lstFurniture)
      {
      ...
      private static float GetProbabilityOfFallingV1(CatBehavior p_cat, List<FurnitureDropSlotBehaviour> p_lstFurniture)
      {
         /* ### RULE 1 ### */
      ...
      private static int TryClimbingV1(CatBehavior p_cat, List<FurnitureDropSlotBehaviour> p_lstFurniture)
      {
