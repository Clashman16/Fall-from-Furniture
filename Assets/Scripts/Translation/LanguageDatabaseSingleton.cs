...
namespace FFF.Translations
{
   public sealed class LanguageDatabaseSingleton
   {
      ...
      private LanguageDatabaseSingleton()
      {
         ...
         List<TranslationEntry> l_frenchTranslation = m_database.m_lstFrenchInit;
         List<TranslationEntry> l_englishTranslation = m_database.m_lstEnglishInit;
